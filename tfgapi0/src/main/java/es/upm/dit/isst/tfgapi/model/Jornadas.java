...
public class Jornadas {
    ...
    private Date entrada_teorica;
    private Date salida_teorica;
    ...
    public void setEntrada_teorica(Date entrada_teorica) {
        this.entrada_teorica = entrada_teorica;
    }
    public Date getSalida_teorica() {
        return salida_teorica;
    }
    public void setSalida_teorica(Date salida_teorica) {
